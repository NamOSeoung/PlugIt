...
class CarRegistModelOptionVC2: UIViewController {

//    @IBOutlet weak var modelWrap: UIView!
//    @IBOutlet weak var modelImageWrap: UIView!
//
//
////    var carRegistModelOptionCell : CarRegistModelOptionCell?
//
...
//        self.uiInit()
//
//        self.modelOptionCV.register(UINib(nibName: "CarRegistModelOptionCell", bundle: nil), forCellWithReuseIdentifier: "CarRegistModelOptionCell")
//
